            ...
            mounth_picker
                ...
                .on('mousedown.xdsoft', '.xdsoft_option', function (event) {
                    ...
                    if (_xdsoft_datetime && _xdsoft_datetime.currentTime) {
                        if ($(this).parent().parent().hasClass('xdsoft_monthselect')) {
                            var selectedMonth = $(this).data('value');

                            var currentTime = new Date(_xdsoft_datetime.currentTime);
                            currentTime.setMonth(selectedMonth, 1);

                            var countDaysInMonth = currentTime.countDaysInMonth();
                            var day = _xdsoft_datetime.currentTime.getDate();
                            day = day > countDaysInMonth ? countDaysInMonth : day;
                            _xdsoft_datetime.currentTime.setMonth(selectedMonth, day);
                        } else {
